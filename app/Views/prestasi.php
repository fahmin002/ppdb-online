...
$prestasi = [
    array(
        ...
        "href" =>   "https://smppgri1puring.sch.id/read/6/smp-pgri-1-puring-raih-juara-1-voli-putra-juara-2-voli-putri-dan-juara-3-gps-yogyakarta",
        "content" => [
    ...
    array(
        ...
        "href" =>   "https://smppgri1puring.sch.id/read/7/smp-pgri-1-puring-raih-juara-3-putri-di-jambore-kemah-wisata-pantai-suwuk",
        "content" => [
            "SMP PGRI 1 Puring dengan bangga mengumumkan bahwa tim putri kami berhasil meraih Juara 3 dalam ajang Jambore & Kemah Wisata Pantai Suwuk. Keberhasilan ini merupakan hasil dari kerja keras, semangat kebersamaan, dan keterampilan yang ditunjukkan oleh para peserta selama kegiatan."
        ]
    )
]
?>
<section id="prestasi" class="py-5">
    ...
    <?php for ($i = 0; $i < count($prestasi); $i++) { ?>
        <div class="container card">
            <a target="_blank" href="<?= $prestasi[$i]['href'] ?>" class="row align-items-center card-body text-decoration-none">
