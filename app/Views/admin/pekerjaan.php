...
<main>
  <div class="container-fluid px-4">
    ...
    <div class="row mt-4 mb-3">
      <div class="col-md-8">
        <h1 class="fw-bold text-primary"><i class="fas fa-briefcase me-2"></i>Halaman Pekerjaan</h1>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/admin" class="text-decoration-none"><i class="fas fa-home me-1"></i>Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Tabel Pekerjaan</li>
          </ol>
        </nav>
      </div>
      <div class="col-md-4 text-end">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addJobModal">
          <i class="fas fa-plus-circle me-1"></i> Tambah Pekerjaan
        </button>
      </div>
    </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-center gap-2">
                      ...
                      <!-- Tombol Hapus -->
                      <form action="/pekerjaan/delete/<?= $d['id_pekerjaan']; ?>" method="post" class="d-inline">
