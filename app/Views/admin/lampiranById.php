...
<main>
  <div class="container-fluid px-4">
    ...
    <div class="row mt-4 mb-3">
      <div class="col-md-8">
        <h1 class="fw-bold text-primary"><i class="fa-solid fa-file-export"></i>Daftar lampiran <?= $nama_lengkap ?></h1>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/admin" class="text-decoration-none"><i class="fas fa-home me-1"></i>Dashboard</a></li>
          <li class="breadcrumb-item"><a href="/admin/lampiran" class="text-decoration-none"><i class="fa-solid fa-file-export"></i>Lampiran</a></li>
            <li class="breadcrumb-item active" aria-current="page"><?= $nama_lengkap ?></li>
          </ol>
        </nav>
      </div>
            ...
            <tbody>
              ...
              foreach ($lampiran as $d) : ?>
                <tr>
                  ...
                  <td><?= esc($d['jenis_lampiran']); ?></td>
                  <td>
                    <a href="<?= base_url('uploads/lampiran/' . $d['file_lampiran']) ?>" class="badge pdf">
